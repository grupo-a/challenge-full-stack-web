...
<template>
  <div>
    ...
    <div v-if="deleteSuccess" >
      <notification
        :messege="deletemSuccessMessage"
        :openNotification="deleteSuccess"
        :color="deleteColor"
      />
    </div>
    <v-data-table-server
